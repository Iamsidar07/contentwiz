...
const Result = ({ result }) => {
  return (
    <Fade bottom>
      <div className={"w-full  md:max-w-6xl mx-auto p-2 md:p-4 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 bg-opacity-0.8 backdrop-blur mb-6 relative rounded-lg shadow"}>
