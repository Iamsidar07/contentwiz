  ...
  return (
      ...
      <main className="py-4 ">
        ...
        <section className='flex px-2 flex-col  items-center justify-around max-w-7xl mx-auto leading-3  space-y-5 min-h-[calc(100vh-68px)]'>
          <div className='space-y-2'>
              <h1 className='text-center text-3xl font-semibold md:text-7xl text-transparent bg-clip-text bg-gradient-to-br from-black to-blue-600'>Transforming the way you
    <span className="text-blue-600"> create content.</span></h1>
        ...
        <section className={`flex items-center justify-center py-4 md:px-[2%] h-48 bg-[#f6f5fa]`}>
          <h2 className='text-5xl md:text-6xl font-semibold text-center md:text-left'>Always <span className='text-blue-500'>free!</span> </h2>
        </section>
      </main>
    </div>
  )
